...
form.addEventListener('submit', async function(e) {
  ...
  try {
    ...
    const options = {
      ...
      handler: async function(response) {
        try {
          ...
          submitPopup.style.display = 'none';
          window.location.href = `/success.html?plan=${encodeURIComponent(formData.plan)}&amount=${amount}&paymentId=${response.razorpay_payment_id}`;
          ...
          submitPopup.style.display = 'none';
          window.location.href = `/failed.html?plan=${encodeURIComponent(formData.plan)}&reason=verification_failed`;
        }
      },
      ...
      modal: {
        ondismiss: async function() {
          ...
          submitPopup.style.display = 'none';
          window.location.href = `/failed.html?plan=${encodeURIComponent(formData.plan)}&reason=user_cancelled`;
        }
      }
    };
    ...
    submitPopup.style.display = 'none';
    window.location.href = `/failed.html?plan=Ultimate%20Personal%20Coaching&reason=${encodeURIComponent(err.message)}`;
  }
});
